...
<h1>BanaNAS - home NAS solutin</h1>
...
BananPi is not fully opensource hw but it have: SATA connector, 1Gbit ethernet port, 1GB RAM.
...
<li>NFS server - mounted on FreeBSD and Linux station via autofs
...
<li>DLNA server - I can play some multimedia files on my XBOX 360.
</ul>
</p>
